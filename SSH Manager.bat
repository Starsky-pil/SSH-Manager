@echo off
    Title SSH Login by Starsky version 1.9
    ::  Version 64-bit
    echo If it's your first start or you just moved the file, it can take a while. . .
:packagechecking    
...
:SSHK
    ...
    echo Your file is in SSHPK (if the upload failed move it in %upload% and send it to the server by using option 3).
    timeout /t 10
    goto :main
